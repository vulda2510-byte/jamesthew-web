  ...
  async up(queryInterface, Sequelize) {
    await queryInterface.createTable(
      'user_sessions',
      {
        ...
        session_token_id: { type: Sequelize.STRING(255), allowNull: false },
        refresh_token_hash: { type: Sequelize.STRING(255), allowNull: true },
        device_name: { type: Sequelize.STRING(100), allowNull: true },
        device_type: { type: Sequelize.STRING(50), allowNull: true },
        browser: { type: Sequelize.STRING(100), allowNull: true },
        operating_system: { type: Sequelize.STRING(100), allowNull: true },
    ...
    await queryInterface.addIndex('user_sessions', ['deleted_at'], { name: 'idx_user_sessions_deleted_at' });
  },
