...
module.exports = {
  async up(queryInterface, Sequelize) {
    await queryInterface.createTable('user_profiles', {
        id: { type: Sequelize.CHAR(100), defaultValue: Sequelize.UUIDV4, primaryKey: true, allowNull: false },
        user_id: {
        ...
        cover_image_url: { type: Sequelize.STRING(255), allowNull: true },
    ...
    await queryInterface.addConstraint('user_profiles', { fields: ['user_id'], type: 'unique', name: 'uk_user_profiles_user_id' });
    await queryInterface.addIndex('user_profiles', ['deleted_at'], { name: 'idx_user_profiles_deleted_at' });
  },
